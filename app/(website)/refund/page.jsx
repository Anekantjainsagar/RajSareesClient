  ...
  return (
    <div className={`py-10 px-[4vw] text-grey ${sansation.className}`}>
      ...
      <div className="px-2 md:px-4 mt-2">
        <p className="mb-2">
          SAROJ SURIN RATHORE believes in helping its customers as far as
          possible, and has therefore a liberal cancellation policy. Under this
          policy:
        </p>
        {[
          "Cancellations will be considered only if the request is made immediately after placing the order. However, the cancellation request may not be entertained if the orders have been communicated to the vendors/merchants and they have initiated the process of shipping them.",
          "SAROJ SURIN RATHORE does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.",
          ...
          "In case of complaints regarding products that come with a warranty from manufacturers, please refer the issue to them. In case of any Refunds approved by the SAROJ SURIN RATHORE, it’ll take 9-15 Days days for the refund to be processed to the end customer",
        ].map((e) => {
          return (
