...
const Tnc = () => {
  return (
    <div className={`py-10 px-[4vw] text-grey ${sansation.className}`}>
      <h1 className="text-brown text-2xl font-bold">Terms & Conditions</h1>
      <div className="px-2 md:px-4 mt-2">
        <p className="mb-2">
          These Terms and Conditions, along with privacy policy or other terms
          (“Terms”) constitute a binding agreement by and between SAROJ SURIN
          RATHORE, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or
        ...
        {[
          ...
          "All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Neyveli, Tamil Nadu.",
